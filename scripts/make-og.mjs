...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="1" stop-color="#f1eefe"/>
    </linearGradient>
    <linearGradient id="brand" x1="80" y1="200" x2="900" y2="400" gradientUnits="userSpaceOnUse">
  ...
  <g transform="translate(80,86)">
    <rect x="0" y="0" width="52" height="52" rx="14" fill="url(#brand)"/>
  ...
  <text x="80" y="374" font-family="Inter, sans-serif" font-size="70" font-weight="700" fill="#101828" letter-spacing="-2">issues in <tspan fill="url(#brand)">minutes.</tspan></text>
